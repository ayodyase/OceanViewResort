  ...
  <main>
    ...
    <section class="section">
      ...
      <div class="section-grid">
        <div class="panel">
          <h4>Rate Details</h4>
          <form method="post" action="${pageContext.request.contextPath}/rooms/rates/save" autocomplete="off">
            <input type="hidden" name="id" value="<c:out value='${rateForm.id}'/>" />
            <div class="form-row">
              <div class="field">
          ...
          <table class="table">
            ...
            <tbody>
              <c:forEach var="rate" items="${rateList}">
                <tr>
                  <td><c:out value="${rate.roomType}" /></td>
                  <td><c:out value="${rate.season}" /></td>
